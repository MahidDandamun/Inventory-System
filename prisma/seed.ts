...
import { PrismaClient, UserRole, Status, OrderStatus, InvoiceStatus } from "@prisma/client";
	...
	const productData = [
		{
			...
			price: 12500.0,
			quantity: 15,
			description: "Heavy-duty drill press for industrial use",
			warehouseIndex: 0,
		},
		{
		...
		},
		{
			...
			price: 45000.0,
			quantity: 6,
			description: "50-ton hydraulic press for metal forming",
			warehouseIndex: 1,
		},
		{
			name: "Lathe Machine 2m",
			sku: "PRD-LTH-001",
			price: 32000.0,
			quantity: 8,
			description: "2-meter precision lathe machine",
			warehouseIndex: 1,
		},
		{
			name: "Welding Station Pro",
			sku: "PRD-WLD-001",
			price: 9800.0,
			quantity: 20,
			description: "Professional MIG/TIG welding station",
			warehouseIndex: 2,
		},
		{
			...
			price: 2500.0,
			quantity: 45,
			description: "Professional angle grinder set with accessories",
			warehouseIndex: 2,
		},
		{
			...
			price: 7500.0,
			quantity: 12,
			description: "100-liter industrial air compressor",
			warehouseIndex: 3,
		},
		{
			name: "Bench Vise Heavy",
			sku: "PRD-BVS-001",
			price: 3200.0,
			quantity: 30,
			description: "Heavy-duty bench vise with swivel base",
			warehouseIndex: 3,
		},
		{
			...
			price: 850.0,
			quantity: 100,
			description: "ANSI-certified industrial safety helmets",
			warehouseIndex: 0,
		},
		{
			...
			price: 6500.0,
			quantity: 10,
			description: "Heavy-gauge steel workbench",
			warehouseIndex: 1,
		},
		{
			name: "Digital Caliper Pro",
			sku: "PRD-CAL-001",
			price: 1200.0,
			quantity: 25,
			description: "Professional digital caliper 0–300mm",
			warehouseIndex: 2,
		},
		{
			...
			price: 4800.0,
			quantity: 18,
			description: "Preset torque wrench set with case",
			warehouseIndex: 3,
		},
		{
			...
			price: 5200.0,
			quantity: 7,
			description: "Heavy-duty steel shelving unit 5 tiers",
			warehouseIndex: 0,
		},
		{
			name: "Forklift Pallet Jack",
			sku: "PRD-PLJ-001",
			price: 22000.0,
			quantity: 4,
			description: "Electric pallet jack 2000kg capacity",
			warehouseIndex: 1,
		},
		{
			name: "Hand Trolley",
			...
			price: 1800.0,
			quantity: 22,
			description: "Foldable hand trolley 150kg capacity",
			warehouseIndex: 2,
		},
	];
		...
		if (status === OrderStatus.DELIVERED || (status === OrderStatus.SHIPPED && Math.random() > 0.4)) {
			...
			const invoice = await prisma.invoice.create({
				data: {
					...
					orderId: order.id,
					total: order.total,
					status: status === OrderStatus.DELIVERED ? InvoiceStatus.PAID : InvoiceStatus.ISSUED,
					dueDate,
				},
			});
